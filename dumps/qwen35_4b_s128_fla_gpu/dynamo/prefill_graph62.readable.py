class GraphModule(torch.nn.Module):
    def forward(self, L_x_: "bf16[1, 128, 2560]", L_self_parameters_weight_: "bf16[2560]"):
        l_x_ = L_x_
        ...
        float_1: "f32[1, 128, 2560]" = l_x_.float()
        ...
        float_2: "f32[2560]" = l_self_parameters_weight_.float();  l_self_parameters_weight_ = None
        ...
        type_as: "bf16[1, 128, 2560]" = output_1.type_as(l_x_);  output_1 = l_x_ = None
        return (type_as,)
